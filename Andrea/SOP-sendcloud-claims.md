# SOP — Filing a Shipping Claim (Sendcloud)
...
## Documents required
The carrier needs documents depending on the claim type: loss, delivered but not received, damage, or delayed. Fill in as many fields as possible — the more detail, the better.
